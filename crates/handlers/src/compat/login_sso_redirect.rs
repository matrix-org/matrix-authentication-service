...
use mas_router::{CompatLoginSsoComplete, UrlBuilder, Action, ActionParams};
...
pub async fn get(
    ...
    Ok(url_builder.absolute_redirect(&CompatLoginSsoComplete(login.data, ActionParams { action: params.action })))
}
